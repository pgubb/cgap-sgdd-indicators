...
# Pull fresh data from Google Sheets. load_indicators() already applies
# finalize_indicators() (from R/data_connector.R): the "Sustainability (ESG)"
# mandate label, rebuilt mandate-objective labels, the ordered mandate factor,
# and the LENS_DROPPED_INDICATORS drop list. The runtime loader in app.R uses
# the same function, so the snapshot and live data are shaped identically.
